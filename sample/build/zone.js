...
var ZoneView = React.createClass({displayName: "ZoneView",
    ...
    render: function() {
        ...
        var searching = 
            React.createElement("img", {className: "center", src: "searching.png", alt: "searching", width: screenWidth}) ; 

        if (!this.state.zoneRequested) {
            this.trace('fetching zone data') ;
            res = 
                React.createElement(Zones, {key: this.props.zone, 
            ...
            if (this.state.zone) {
                if (!this.state.sensorDataRequested) {
                    ...
                    res = React.createElement(ZoneQueries, {
                            zone: this.props.zone, 
        ...
        if (this.state.gotZone && this.state.gotSensor) {
            ...
            if (zoneFull) {
                ...
                res = 
                    React.createElement("img", {className: "center", src: "notfound.png", alt: "every spot is occupied", width: screenWidth}) ;
            } else {
                ...
                res = React.createElement(Directions, {
                          key: "map", 
                          zoom: 17, 
        ...
        return (
            React.createElement(DivWrapper, {key: 'zones-'+this.props.guid}, 
            searching, 
            res
            )
        ) ;
